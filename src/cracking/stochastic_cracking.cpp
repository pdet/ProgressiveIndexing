...
IntPair crackInTwoMDD1RPredicated(IndexEntry *&c, int64_t posL, int64_t posH, int64_t low, int64_t high,
                                  ...
                                  int64_t &view_size)  {
    view = (IndexEntry *) malloc(
            (posH - posL + 1) * sizeof(IndexEntry));        // initialize view to the maximum possible size
    int64_t size = 0;
    ...
    if (p1->first == p2->first && p1->second == p2->second) {
        switch(engineType){
            case CrackEngineType ::Branched:{
                pivot_pair = crackInTwoMDD1RBranched(c, p1->first, p1->second, lowKey, highKey, qo->view1,
                                                     qo->view_size1);
            }
                break;
            case CrackEngineType::Predicated:{
                pivot_pair = crackInTwoMDD1RPredicated(c, p1->first, p1->second, lowKey, highKey, qo->view1,
                                                     qo->view_size1);
            }
                break;
        ...
        switch(engineType){
            case CrackEngineType ::Branched:{
                pivot_pair1 = crackInTwoMDD1RBranched(c, p1->first, p1->second, lowKey, highKey, qo->view1,
                                                      qo->view_size1);

            }
                break;
            case CrackEngineType::Predicated:{
                pivot_pair1 = crackInTwoMDD1RPredicated(c, p1->first, p1->second, lowKey, highKey, qo->view1,
                                                      qo->view_size1);
            }
                break;
            case CrackEngineType::Rewired:
        ...
        switch(engineType){
            case CrackEngineType ::Branched:{
                pivot_pair2 = crackInTwoMDD1RBranched(c, p2->first, p2->second, lowKey, highKey, qo->view2,
                                                      qo->view_size2);

            }
                break;
            case CrackEngineType::Predicated:{
                pivot_pair2 = crackInTwoMDD1RPredicated(c, p2->first, p2->second, lowKey, highKey, qo->view2,
                                                      qo->view_size2);
            }
                break;
            case CrackEngineType::Rewired:
