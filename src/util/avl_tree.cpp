...
/* START: fig4_36.txt */
static int64_t Height(PositionAVL P) {
	if (P == NULL)
		return -1;
	else
		return P->Height;
...
static ElementType Max(ElementType Lhs, ElementType Rhs) {
...
static PositionAVL SingleRotateWithLeft(PositionAVL K2) {
	PositionAVL K1;
...
static PositionAVL SingleRotateWithRight(PositionAVL K1) {
	PositionAVL K2;
...
static PositionAVL DoubleRotateWithLeft(PositionAVL K3) {
...
static PositionAVL DoubleRotateWithRight(PositionAVL K1) {
	/* Rotate between K3 and K2 */
