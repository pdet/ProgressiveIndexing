...
''')
cursor.execute('''
    CREATE TABLE queries(experiment_id INTEGER , query_number INTEGER NOT NULL, delta REAL , query_time REAL NOT NULL,indexing_time REAL NOT NULL,total_time REAL NOT NULL, FOREIGN KEY (experiment_id) REFERENCES experiment(id))
''')
# cursor.execute('''
